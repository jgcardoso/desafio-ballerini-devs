...
export function Devs() {
  const [devs, setDevs] =  useState<Dev[]>([
    {
      ...
      job: "Instrutora front-end",
      github: "",
      linkedin: ""
    },
    {
      name: "Jonas Guedes",
      avatar: "https://avatars.githubusercontent.com/u/6835641?v=4",
    ...
    {
      name: "Zeno Rocha",
      avatar: "https://avatars.githubusercontent.com/u/398893?v=4",
      job: "VP of Developer Experience at @WorkOS",
      github: "",
      linkedin: ""
    },
    {
  ...
  if(!devs) return <div>carregando</div>
                  ...
                  <div className={styles.dev}>
                    ...
                    <div>
                      <ul className={styles.devlinks}>
                        ...
                        <li>
                          <a href={dev.github} className="btn btn-primary">Ver mais</a>
                        </li>
                      </ul>
                    </div>
                  </div>
